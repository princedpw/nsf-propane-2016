...
implement these objectives directly, we will develop new \emph{dynamic} abstractions.  
More specifically, we plan to explore the idea of \emph{time-varying policies}---that is, 
routing policies expressed declaratively \emph{functions of time and traffic volume}.  We 
...
under certain conditions.  Such preferences will generalize \Propane's existing \emph{hard preferences} 
which lower preference routes to be used in case of failure, but in no other circumstance.
