...
(1) specify routes (including inter-domain routes), (2) preferences based on network dynamics, and (3) financial contracts.
...
\emph{inter}-domain routing or the associated peering relationships and 
