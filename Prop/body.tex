...
(2) To introduce a range of \emph{rigorous}, \emph{formal} properties of
 interest; (3) To expose students to basic algorithms for verification of such
properties.
