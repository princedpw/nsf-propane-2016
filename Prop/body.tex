...
and hence \Propane's compiler no way to optimize routes to achieve these
business objectives.
...
as suggested in Figure~\ref{fig:optimizer}.  The main inputs to the system are (1) a conventional
